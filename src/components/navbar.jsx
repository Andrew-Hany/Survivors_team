    ...
    return (
      <div>
        ...
        <div className="container-fluid">
          <a className="navbar-brand" onClick={this.props.toogleHome} style={{cursor: "pointer"}}>Survivors</a>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <li className="nav-item">
                <a className="nav-link active"  aria-current="page" onClick={this.props.toogleHome} style={{cursor: "pointer"}}>Home</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" onClick={this.props.tooglePro} style={{cursor: "pointer"}}>Profile</a>
              </li>
